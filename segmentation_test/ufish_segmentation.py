...
cond_3d  = cond_mask_stack   # already boolean
nuc_3d   = nuc_mask_stack
...
print(f"\nU-FISH Partition Coefficient (background-subtracted): {pc:.3f}")
...
summary = pd.DataFrame({
    "metric": ["partition_coefficient", "background", "condensate_density", "dilute_density", "total_spots"],
    "value":  [pc, B, cond_density, dilute_density, len(spots_df)],
})
